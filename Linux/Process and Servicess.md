...
![ps Linux command - TestingDocs](https://www.testingdocs.com/wp-content/uploads/ps-Linux-command.png)
...
##### `systemd` is the default system and service manager for modern Linux.
...
- `systemctl daemon-reload`: Reloads `systemd` after unit file changes.